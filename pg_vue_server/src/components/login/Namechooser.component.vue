<template>
  <div class="namechooser">
    <img src="../../assets/img/_logo/web/PhenixGames_Logo_no_text.svg" ondragstart="return false"/>

    <form class="namechooserform" @submit="submitForm" v-show="showNamechooser">
      <p class="desc white bold user-select-none">Bitte gebe deinen zukünftigen Charakternamen ein.</p>
    ...
    <div class="confirmMessage white" v-show="showConfirmMessage">
      ...
      <p>Der Name kann <i><strong>nicht</strong></i> ohne weiteres verändert werden!</p>
      <form>
    ...
    submitForm(e) {
      ...
      if (this.firstname === "" || this.lastname === "") {
        return (this.error_msg =
          "Der Vor- und Nachname darf nicht frei bleiben!");
      }
